...
$routes = [
    ...
    '/admin/bakery-pos' => 'pg_admin_pos',
    '/admin/bakery-pos/suggest' => 'pg_pos_suggest',
    '/admin/bakery-pos/add' => 'pg_pos_add',
    '/admin/bakery-pos/update' => 'pg_pos_update',
    '/admin/bakery-pos/remove' => 'pg_pos_remove',
    '/admin/bakery-pos/customer' => 'pg_pos_customer',
    '/admin/bakery-pos/suspend' => 'pg_pos_suspend',
    '/admin/bakery-pos/resume' => 'pg_pos_resume',
    '/admin/bakery-pos/suspend-delete' => 'pg_pos_suspend_delete',
    '/admin/bakery-pos/cancel' => 'pg_pos_cancel',
    '/admin/bakery-pos/complete' => 'pg_pos_complete',
    '/admin/purchases' => 'pg_admin_purchases',
    '/admin/transfers' => 'pg_admin_transfers',
    '/admin/invoices' => 'pg_admin_invoices',
    '/admin/quotations' => 'pg_admin_quotations',
    '/admin/warehouse' => 'pg_admin_warehouse',
